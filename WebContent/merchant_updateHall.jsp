...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="index.jsp">Home</a> / Update Hall</span>
...
<form action="merchant_updateHall.jsp" method="post">
	 ...
	 <h4 style="color: #6bb30c;">Select Hall</h4>
		...
		<%
					String hallDetails = request.getParameter("hallName");
					statement = connection.createStatement();
					resultset = statement.executeQuery("Select * from HallDetails where UserId = '"+ hallDetails +"' ");
					while (resultset.next()) {
				%>				
<div class="container">
<div class="spacer">
...
<form action="UpdateHallServlet" method="post">
										...
										%>
										<h2>
											<p style="color: green">Details Successfully Updated...!!</p>
										</h2>
										<%
											}
											}
 ...
 <h4 style="color: #6bb30c;">Hall Details</h4>
		...
		<div class="row">
			...
			<div class="col-md-6">
				  ...
				  <div class="form-group">
					<label class="control-label col-sm-4" for="email">Name of Hall:</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" name="hall_name" placeholder="" value="<%=session.getAttribute("hall_name") %>"  >
					</div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-8">
					  <input type="text" class="form-control" name="area_sqft" placeholder="" value=""  >
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-8"> 
					  <input type="text" class="form-control" name="no_of_rooms" value=""  >
					</div>
				  </div>
				  
				  <div class="form-group">
					<label class="control-label col-sm-4" for="email">No. of floor:</label>
					<div class="col-sm-8">
			...
			<div class="col-md-6">
				  ...
				  <div class="form-group">
					<label class="control-label col-sm-4" for="pwd">Kitchen Room: </label>
					<div class="col-sm-8">
		...
		<div class="row">
			...
			<div class="col-md-6">
				  <div class="form-group">
					...
					<div class="col-sm-8"> 
					  <input type="text" class="form-control" name="sub_locality" value=""  >
					</div>
				  </div>
				  <div class="form-group">
		...
		<div class="row">
			...
			<div class="col-md-6">
					...
					<div class="col-sm-8"> 
					  <input type="text" class="form-control" name="hall_rent" value=""  >
					</div>
				  </div>
				  <div class="form-group">
					<label class="control-label col-sm-4" for="pwd">Maintenance Charge</label>
					<div class="col-sm-8"> 
					  <input type="text" class="form-control" name="maintenance" value=""  >
					</div>
				  </div>				   
		...
		<div class="row">
			...
			<div class="col-md-6">
				  <div class="form-group">
					<label class="control-label col-sm-4" for="pwd">Catering Service:</label>
					<div class="col-sm-8"> 
		...
		<div class="row">
			...
			<div class="col-md-6">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" name="contact_name" value="" required="required"/>
					</div>
				  </div>
				  <div class="form-group">
					<label class="control-label col-sm-4" for="pwd">Mobile Number:</label>
					<div class="col-sm-8"> 
						<input type="number" class="form-control" name="mobile_no" value="" required="required"/>
					</div>
				  </div>				   
			...
			<div class="col-md-6">
				  <div class="form-group">
					...
					<div class="col-sm-8"> 
						<input type="email" name="email_id" class="form-control" value="" required="required"/>
					</div>
				  </div>
				  <div class="form-group">
		...
		<div class="row">
				...
				<div class="form-group">
					<div class="col-sm-12"> 
						<input style="float: none; margin-left: 44.5%" type="submit" name="button" class="button btn btn-primary btn-large" value="Update"/>
					</div>
				  </div>
		</div>		
 </form>
 <form action="dashboard_merchant.jsp">
 				<div class="col-sm-12"> 
									<input style="float: none; margin-left: 44.5%" name="button"
										type="submit" class="button btn btn-primary btn-large" value="<< Back" />
				</div>
 </form> 
</div>
</div>
