...
<!-- Header Starts -->
<div class="header">
<h1 style="color: #514b4b;">Welcome on Hall Renting Service</h1>
...
<!--         
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">The only renting service in the region..!</a></h2>
              <blockquote>              
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              <div class="bg-img bg-img-2"></div>
               <h2>Welcome on the hall renting service..!</h2>
              
              <div class="banner-search">
  <div class="container"> 
    <!-- banner -->
    <h3>Search for Celebration Hall</h3>
    <div class="searchbar">
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
              <select class="form-control">
                ...
                <option>51,000 - 1,00,000</option>
                <option>1,10,000 - 1,50,000</option>
                <option>1,51,000 - above</option>
              </select>
            </div>
            <div class="col-lg-3 col-sm-4">
            <select class="form-control">
              ...
              <div class="col-lg-3 col-sm-4">
              <button class="btn btn-success"  onclick="window.location.href='search_hall.jsp'">Find Now</button>
              </div>
          </div>
        ...
        <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
          <button class="btn btn-success"   data-toggle="modal" data-target="#loginmodel">Login</button>      
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-6 col-sm-9 recent-view">
        <h3>About Us</h3>
        <p>Hall Renting Services is the very first portal of the region which provide service to search the function hall for renting. </p>
        <p>We also provides services like;</br>
        Decoration Facility</br>
        Food And Catering Services</br>
        Transportation Facility </br>
        We always try to make your ceremony very special and headacheless </br></br>
    ...
    <div class="modal-content">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <button type="submit" class="btn btn-info"  onclick="window.location.href='registration.jsp'">Join Now</button>
        </div>
