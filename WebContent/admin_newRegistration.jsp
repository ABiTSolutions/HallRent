...
<title>Admin Register | Hall Renting Service</title>
<meta charset="UTF-8" />
...
<body>
	...
	<div class="inside-banner">
		<div class="container">
			<span class="pull-right"><a href="index.jsp">Home</a> |
				Register</span>
			<h2>Register</h2>
		</div>
	</div>
		...
		<div class="spacer">
			<div class="row register">
				<div
					...
					<form class="" role="form" action="RegistrationServlet"
						method="post">
