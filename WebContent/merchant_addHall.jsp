...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="index.jsp">Home</a> / Add Hall</span>
    <h2>Add Hall</h2>
</div>
</div>
<!-- banner -->
...
<form action="AddHallServlet" method="post">
 ...
 <h4 style="color: #6bb30c;">Hall Details</h4>
		...
		<div class="row">
			...
			<div class="col-md-6">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-8">
					  <input type="text" class="form-control" name="hall_name" placeholder="" value=""  >
					</div>
				  </div>
				  <div class="form-group">
		...
		<div class="row">
				...
				<div class="form-group">
					<div class="col-sm-12"> 
						<input style="float: none; margin-left: 44.5%" type="submit" name="button" class="button btn btn-primary btn-large" value="Post >>"/>
					</div>
				  </div>
		</div>		
 </form>
