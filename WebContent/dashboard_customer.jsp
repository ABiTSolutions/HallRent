        ...
        <div class="span12">
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="shortcuts"> 
			     <a href="customer_profile.jsp" class="shortcut">
					<i class="shortcut-icon icon-list-alt"></i>
					<span class="shortcut-label">Profile</span> 
				</a>
				<a href="customer_searchHall.jsp" class="shortcut">
					<i class="shortcut-icon icon-list-alt"></i>
					<span class="shortcut-label">Search Hall</span> 
				</a>
				<a href="customer_updateHall.jsp" class="shortcut">
					<i class="shortcut-icon icon-list-alt"></i> 
					<span class="shortcut-label"> Feedback </span> 
				</a>
