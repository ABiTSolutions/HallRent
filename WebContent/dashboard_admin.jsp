			...
			<div class="container">
              ...
              <h3>Important Shortcuts</h3>
							...
							<div class="widget-content">
								<div class="shortcuts">
									<a href="admin_profile.jsp" class="shortcut"> <i
										class="shortcut-icon icon-list-alt"></i> <span
										class="shortcut-label">Profile</span>
									</a> <a href="admin_merchantDetails.jsp" class="shortcut"> <i
										class="shortcut-icon icon-list-alt"></i> <span
										class="shortcut-label">Merchant Details</span>
